...
export const recordBorrowedBook = (email, id) => async (dispatch) => {
    ...
    await axios
        .post(`http://localhost:4000/api/v1/borrow/record-borrow-book/${id}`, { email}, { withCredentials: true, 
...
export const returnBook = (email, bookId) => async (dispatch) => {
    ...
    await axios
        .put(`http://localhost:4000/api/v1/borrow/return-bowwored-books/${bookId}`, { email}, { withCredentials: true, 
            headers: { 'Content-Type': 'application/json' } })
